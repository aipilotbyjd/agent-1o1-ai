...
/**
 * The subscription plan catalog. Paid plans read their Stripe price IDs from
 * env — they must be created ahead of time in the Stripe dashboard.
 */
    ...
    private function catalog(): array
    {
        return [
            ...
            [
                ...
                'features' => ['git_sync' => true, 'workflow_approvals' => true],
            ...
            [
                ...
                'features' => ['git_sync' => true, 'workflow_approvals' => true, 'custom_nodes' => true, 'priority_support' => true],
